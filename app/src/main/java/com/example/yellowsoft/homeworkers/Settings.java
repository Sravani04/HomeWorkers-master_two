...
public class Settings implements Serializable {
    public String logo,title,title_ar,email,phone,image1,image2,image3,image4,avail_amount,about,about_ar,contact,contact_ar,privacy,privacy_ar,terms,terms_ar,home_req_amount;
    public Settings(JsonObject jsonObject, Context context){
        ...
        home_req_amount = jsonObject.get("home_req_amount").getAsString();
