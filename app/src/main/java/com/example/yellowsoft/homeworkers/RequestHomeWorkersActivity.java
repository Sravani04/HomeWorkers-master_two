...
public class RequestHomeWorkersActivity extends Activity {
    LinearLayout male,female,select_religion,select_nationality,yes,no,select_service,select_age;
    ImageView male_checkbox,female_checkbox,yes_checkbox,no_checkbox,age_close_btn;
    TextView male_option,female_option,yes_option,no_option,submit_btn;
    EditText phone,service_option,religion_option,nationality_option,age;
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        agefrom_api.add("18-25");
        agefrom_api.add("20-25");
        agefrom_api.add("30-35");
        agefrom_api.add("40-45");
        agefrom_api.add("50-55");
        agefrom_api.add("60-65");
        ...
        service_option = (EditText) findViewById(R.id.service_option);
