...
public class EmployeeRequestActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        expected_sal = (EditText) findViewById(R.id.expected_sal);
        ...
        next_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("family_name",family_name.getText().toString());
                intent.putExtra("date_of_birth",dateofbirth_option.getText().toString());
                intent.putExtra("place_of_birth",place_of_birth.getText().toString());
                intent.putExtra("nationality",nationality_option.getText().toString());
                intent.putExtra("expirydate",expirydate_option.getText().toString());
                intent.putExtra("article",article_number.getText().toString());
                intent.putExtra("address",address.getText().toString());
                intent.putExtra("telephone",telephone_number.getText().toString());
                intent.putExtra("mobile",mobile_number.getText().toString());
                intent.putExtra("email",email.getText().toString());
                intent.putExtra("position_applied_for",post_option.getText().toString());
                intent.putExtra("do_you_work_now",checked);
                intent.putExtra("when_can_youstart",start.getText().toString());
                intent.putExtra("expectedsal",expected_sal.getText().toString());
                intent.putExtra("marital_status",marital_status_option.getText().toString());
